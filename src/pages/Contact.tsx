  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "با تشکر از تماس شما. به زودی با شما ارتباط برقرار خواهیم کرد.",
      });
      setFormData({
        name: '',
        email: '',
      ...
      <section className="bg-gradient-to-r from-orange-500 to-orange-600 text-white py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg opacity-90 max-w-2xl mx-auto">
            سوال یا بازخوردی دارید؟ با ما در ارتباط باشید. تیم ما آماده پاسخگویی به شماست.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    <div className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-orange-100 text-orange-500 ml-4">
                      <MapPin className="h-5 w-5" />
                    </div>
                    <div>
                      <h4 className="font-bold mb-1">آدرس</h4>
                      <p className="text-gray-600">تهران، خیابان ولیعصر، پلاک ۱۲۳، طبقه ۴</p>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <h3 className="text-xl font-bold mb-6">ما را دنبال کنید</h3>
                <div className="flex space-x-reverse space-x-4">
                  <a href="#" className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 text-gray-600 hover:bg-orange-100 hover:text-orange-500 transition-colors">
        ...
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-lg shadow-md p-4">
            <div className="aspect-w-16 aspect-h-9">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d103681.87528761656!2d51.31242400224608!3d35.73100550000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3f8e00e4c4f5adbd%3A0x7923d0e51a38f0c5!2sTehran%20Province%2C%20Tehran!5e0!3m2!1sen!2sir!4v1683876297522!5m2!1sen!2sir" 
                width="100%" 
                height="450" 
                style={{ border: 0 }} 
                allowFullScreen 
